...
\begin{align}
  g(z_1+\varepsilon w_1,z_2+\varepsilon w_2) &= g(z_1,z_2+\varepsilon w_2) + \varepsilon\pder{g}{z_1}(z_1,z_2+\varepsilon w_2) w_1 + o(\varepsilon) \\
                                       &= g(z_1,z_2) + \varepsilon\pder{g}{z_2}(z_1,z_2)w_2 + \varepsilon\pder{g}{z_1}(z_1,z_2)w_1 \\
                                       & \qquad + \varepsilon^2\pder{^2 g}{z_2\partial z_1}(z_1,z_2)w_1w_2 + o(\varepsilon) \\
                                       &= g(z_1,z_2) + \varepsilon\pder{g}{z_1}(z_1,z_2)w_1 + \varepsilon\pder{g}{z_2}(z_1,z_2)w_2 + o(\varepsilon)
\end{align}
...
\item If
  ...
  See Fig.~\ref{fig:var_u_x}. Note $\eta(0)=0$.
\end{enumerate}
...
\begin{align}
  ...
  \tilde J(\tau+\varepsilon\theta) - \tilde J(\tau) &= \int_0^\tau 0\cdot\dif t + \underbrace{ \int_\tau^{\tau+\varepsilon\theta} \left[ \varepsilon\pder{L}{x}\eta + \lambda\trans \Big(f_1(x)+\varepsilon\pder{f_1}{x}\eta - f_2(x) - \varepsilon\dot\eta \Big) \right] \dif t }_{\displaystyle I_1} \\[-3ex]
