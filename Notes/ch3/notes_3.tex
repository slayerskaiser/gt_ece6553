...
\begin{center}
  \begin{tikzpicture}
    ...
    \draw [rotate=90] (0) parabola (3,3) node [above] {$[-x_2^2/2,\ x_2]\trans,\ x_2\ge 0$};
    ...
    \draw [rotate=-90] (0) parabola (3,3) node [below] {$[x_2^2/2,\ x_2]\trans,\ x_2\le 0$};
    \draw [very thin,-<,>={Straight Barb[scale=3,line width=1pt]},rotate=-90] (0,0) parabola (2.12,1.5);
    \node [pin={[pin distance=1cm]30:{curve if $u=+1$ $\forall t$}}] at (0.8,-1.5) {};
  \end{tikzpicture}
\end{center}
...
\begin{center}
  \begin{tikzpicture}
    ...
    \draw [thick,->] (0,-3) -- (0,3) node [above] {$x_2$};
    \node [dot] at (0) {};
    \draw [rotate=90,ultra thick] (0) parabola (3,3) node [above] {$u=-1$};
    \draw [very thin,-<,>={Straight Barb[scale=3,line width=1pt]},rotate=90] (0,0) parabola (2.12,1.5);
    \draw [rotate=-90,ultra thick] (0) parabola (3,3) node [below] {$u=+1$};
    \draw [very thin,-<,>={Straight Barb[scale=3,line width=1pt]},rotate=-90] (0,0) parabola (2.12,1.5);
...
\begin{center}
  \begin{tikzpicture}
    \node [dot] at (0) {};
    \node [below,yshift=-1pt] at (0) {$O$};
    \draw [decorate,decoration={snake,segment length=1cm}] (0) circle (2);
    \path (0) -- ++(40:2.2) coordinate (a);
    \draw [{Straight Barb[scale=2]}-,thick] (a) to[out=40,in=180] ++(20:1.5) node [right,align=left] {contours of \\ constant \\ time-to-go};

    \path (0) -- ++(-20:2.2) coordinate (b);
